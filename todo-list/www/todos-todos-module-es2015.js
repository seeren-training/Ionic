...
/* harmony import */ var src_app_shared_services_loading_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/services/loading.service */ "./src/app/shared/services/loading.service.ts");
/* harmony import */ var _state_enum_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./state.enum.model */ "./src/app/todos/shared/state.enum.model.ts");
/* harmony import */ var _todo_form_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./todo-form.service */ "./src/app/todos/shared/todo-form.service.ts");
/* harmony import */ var _todo_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./todo.service */ "./src/app/todos/shared/todo.service.ts");
...
let StateService = class StateService {
    constructor(todo, todoForm, loading) {
        this.todo = todo;
        this.todoForm = todoForm;
        this.loading = loading;
    }
    doing() {
        return this.todoForm.form.valid
            ? this.todo.post({
            ...
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(() => this.todoForm.form.reset()))
            : this.todo.get();
    }
    done(todo) {
        ...
        this.loading.start();
        return this.todo.put(this.todo.todoList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(() => this.loading.stop(), () => todo.state = _state_enum_model__WEBPACK_IMPORTED_MODULE_4__["State"].DOING));
    }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TodoFormService", function() { return TodoFormService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let TodoFormService = class TodoFormService {
...
TodoFormService.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
TodoFormService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], TodoFormService);
...
/* harmony import */ var src_app_shared_services_loading_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/services/loading.service */ "./src/app/shared/services/loading.service.ts");
...
let TodoService = class TodoService {
    ...
    get() {
        ...
        this.loading.start();
        return this.http
            .get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].jsonbin.url, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ "secret-key": src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].jsonbin.key })
        })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((todoList) => {
            this.loading.stop();
    ...
    post(todo) {
        ...
        this.loading.start();
        return this.put(this.todoList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => this.loading.stop(), () => this.todoList.pop()));
    }
    put(todoList) {
    ...
    delete(todo) {
        ...
        this.loading.start();
        return this.put(this.todoList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(() => this.loading.stop(), () => this.todoList.splice(index, 0, todo)));
    }
    findByName(name) {
...
/* harmony import */ var _shared_todo_form_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shared/todo-form.service */ "./src/app/todos/shared/todo-form.service.ts");
...
let TodoComponent = class TodoComponent {
    constructor(loadingService, titleService, routeService, routerService, todoService, todoFormService) {
        this.loadingService = loadingService;
...
/* harmony import */ var _shared_todo_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./shared/todo.service */ "./src/app/todos/shared/todo.service.ts");
/* harmony import */ var _shared_state_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/state.service */ "./src/app/todos/shared/state.service.ts");
...
let TodosComponent = class TodosComponent {
    constructor(changeService, routerService, titleService, locationService, loadingService, todoService, stateService) {
