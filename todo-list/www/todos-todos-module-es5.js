(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["todos-todos-module"], {
    ...
    function srcAppTodosSharedTodoServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_shared_services_loading_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/shared/services/loading.service */
      "./src/app/shared/services/loading.service.ts");
      /* harmony import */


      var _state_enum_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./state.enum.model */
      "./src/app/todos/shared/state.enum.model.ts");
      ...
      var TodoService = /*#__PURE__*/function () {
         ...
         * @param http
         */
        function TodoService(builderService, http, loading) {
        ...
        _createClass(TodoService, [{
          ...
          value: function get() {
            ...
            this.loading.start();
            return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].jsonbin.url, {
              headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "secret-key": src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].jsonbin.key
              })
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (todoList) {
              _this.loading.stop();

              _this.todoList = todoList.reverse();
            }));
          }
          /**
           * @param todo
          ...
          value: function post(todo) {
            ...
            this.loading.start();
            return this.put(this.todoList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
              return _this2.loading.stop();
            }, function () {
              return _this2.todoList.pop();
            }));
          }
          /**
           * @param todoList
          ...
          value: function put(todoList) {
            return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].jsonbin.url, todoList, {
              headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                "secret-key": src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].jsonbin.key,
                "versioning": "false",
          ...
          value: function _delete(todo) {
            ...
            this.loading.start();
            return this.put(this.todoList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
              return _this3.loading.stop();
            }, function () {
              return _this3.todoList.splice(index, 0, todo);
            }));
          }
        }, {
          key: "doing",
          value: function doing() {
            ...
            return this.post(todo).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
              return _this4.form.reset();
            }));
          }
        }, {
          key: "done",
          value: function done(todo) {
            ...
            return this.put(this.todoList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
              ...
              return todo.state = _state_enum_model__WEBPACK_IMPORTED_MODULE_8__["State"].DOING;
            }));
          }
          /**
           * @param name
    ...
    function srcAppTodosTodoTodoComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_todo_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../shared/todo.service */
      "./src/app/todos/shared/todo.service.ts");
      ...
      var TodoComponent = /*#__PURE__*/function () {
         ...
         * @param todoService
         */
        function TodoComponent(loadingService, titleService, routeService, routerService, todoService) {
        ...
        _createClass(TodoComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.todoService.get().subscribe(function () {
              var name = _this7.routeService.snapshot.params.name;

              if (!name) {
                _this7.form = _this7.todoService.form;
    ...
    function srcAppTodosTodosComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var TodosComponent = /*#__PURE__*/function () {
        function TodosComponent(changeService, routerService, todoService, titleService, locationService, loadingService) {
        ...
        _createClass(TodosComponent, [{
          ...
          value: function done() {
            ...
            this.todoService.done(this.todoService.todo).subscribe(function () {
          ...
          value: function doing() {
            ...
            this.todoService.doing().subscribe(function () {
